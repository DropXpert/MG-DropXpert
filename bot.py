...
class MyGate:
    ...
    def welcome(self):
        print(
            f"""
        {Fore.GREEN + Style.BRIGHT}Auto Ping {Fore.BLUE + Style.BRIGHT}MyGate - Multi Account Without Proxy
            """
            f"""
        {Fore.GREEN + Style.BRIGHT}© {Fore.GREEN + Style.BRIGHT}<TG - DropXpert>
            """
        )
